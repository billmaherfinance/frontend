...
aws s3 cp ./public/blog/index.html s3://billmaher.finance/blog/index.html --acl public-read --content-type "text/html; charset=utf-8"
aws s3 sync ./public/images s3://billmaher.finance/images --acl public-read
aws s3 sync ./public/audios s3://billmaher.finance/aduios --acl public-read
